...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure your settings for Team TNT Search, which is a
    ...
    */
    ...
    'tntsearch' => [
        ...
        'fuzziness' => env('SCOUT_TNT_FUZZINESS', false),
        'fuzzy' => [
            'prefix_length' => env('SCOUT_TNT_FUZZINESS_LENGTH', 2),
            'max_expansions' => env('SCOUT_TNT_FUZZINESS_MAX_EXPANSIONS', 50),
            'distance' => env('SCOUT_TNT_FUZZINESS_DISTANCE', 2)
        ],
    ],
